...
POINT VARCHAR2(10 BYTE) DEFAULT '1000',
GRADE VARCHAR2(10 BYTE) NOT NULL CHECK(GRADE IN('VIP', 'GOLD', 'SILVER', 'BRONZE')),
...
ALTER TABLE GRADE 
    MODIFY GRADE VARCHAR2(10 BYTE) NOT NULL CHECK(GRADE IN('VIP', 'GOLD', 'SILVER', 'BRONZE'));

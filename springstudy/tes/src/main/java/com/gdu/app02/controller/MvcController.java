...
public class MvcController {
	...
	// @RequestMapping(value="/animal", method=RequsetMethod.GET)
	// @RequestMapping(value="animal", 	method=RequsetMethod.GET) 슬래시 없어도됨
	// @RequestMapping(value="/animal") GET은 없어도 됨. POST는 잇어야함

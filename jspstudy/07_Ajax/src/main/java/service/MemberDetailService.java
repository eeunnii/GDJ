...
public class MemberDetailService implements MemberService{
	...
	@Override
	public void execute(HttpServletRequest requset, HttpServletResponse response) throws Exception {
		
		
		//요청 파라미터 
		Optional<String> opt = Optional.ofNullable(requset.getParameter("memberNo"));

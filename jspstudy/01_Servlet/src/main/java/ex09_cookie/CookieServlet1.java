...
public class CookieServlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 쿠키 특징 : 쿠키골라서 가져오는거 안됨
		
		// 쿠키
		// 1. 서버가 만들어서 클라이언트 pc에 저장해 두는 정보 
		// 2. 응답할 때 쿠기를 저장함
		// 3. 클라리언트 요청이 있을 때 모든 쿠키 정보를 읽어 들일 수 있음

		// 쿠기 만들기 
		// 1. 쿠키이름 : 알파벳, 숫자로 만듬
		// 2. 쿠키값 : 공백, 콜론, 세미콜론 등 불가능한 문자가 있는 경우 인코딩해서 포함할 수 있음
		Cookie cookie1 = new Cookie("name","정은지");
		Cookie cookie2 = new Cookie("address",URLEncoder.encode("서울시 금천구 가산동","UTF-8")); // 공백은 아스키코드 32번임. 쿠키값에는 공백 불가능

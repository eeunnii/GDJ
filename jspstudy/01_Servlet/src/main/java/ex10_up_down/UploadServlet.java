...
public class UploadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 * FileUpload를 위한 COS 라이브러리 - 라이브러리의 도움을 받는 것이 좋다 
		 * 		1) http://http://servlets.com/
		...
		MultipartRequest mutipartRequest = new MultipartRequest(
		...
		File file = mutipartRequest.getFile("filename");

...
<body>
	...
	<%--
		EL의 파라미터 처리 
		1. EL 내장객체 param을 사용(param, paramValues--배열로 가져옴 .. 자바 전화번호부할때햇엇음)
		2. 모든 파라미터는 String이므로 크기 비교를 수행할 수 없음. 정상이 아님.
			예시)
			"10","5" 중 누가 큰가? "5"가 크다(문자열의 크기는 사전 편찬 순) -- 문자열비교는 나중에 나온게 큰거임,10을 1로 인식
		3. 파라미터의 크기 비교 
	...
	<div>${param.a+param.b}</div> <!-- EL의 전용 내장객체 param -->

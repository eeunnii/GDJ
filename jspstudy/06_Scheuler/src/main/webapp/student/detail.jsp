	...
	<div>
		<form id="frm_detail" method="POST" action="${contextPath}/student/modify.do">
			...
			<div>
				...
				<input type="text" id="ave" name="ave" value="${student.ave}" readonly> <!-- ave는 파생값임. 수정불가해야함 -->
			</div>
			<div>
				<label for="grade">학점</label>
				<input type="text" id="grade" name="grade" value="${student.grade}" readonly>   <!-- 상세화면과 수정화면을 합쳐버리기 -->
			</div>
			<hr>
			<div>
